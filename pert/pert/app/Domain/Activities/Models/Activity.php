...
{
    protected $fillable = ['teacher_id', 'classroom_id', 'title', 'description', 'grading_instructions', 'deadline_at', 'status', 'published_at', 'released_at', 'total_score'];
    ...
    {
        return $this->hasMany(ActivityQuestion::class)->orderBy('position');
    }
