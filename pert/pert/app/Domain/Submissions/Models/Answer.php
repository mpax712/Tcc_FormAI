...
class Answer extends Model
{
    ...
    public function activityQuestion(): BelongsTo { return $this->belongsTo(ActivityQuestion::class); }
    public function gradingRuns(): HasMany { return $this->hasMany(GradingRun::class); }
    public function gradingDecision(): HasOne { return $this->hasOne(GradingDecision::class); }
}
